...
%-------------------------------------------------- SETTINGS HERE --------------------------------------------------
% Header settings
\def \fullname {Santiago Canabal}
\def \subtitle {Full-Stack Software Engineer}

\def \linkedinicon {\faLinkedin}
\def \linkedinlink {https://linkedin.com/in/santiago-canabal}
\def \linkedintext {/santiago-canabal}

\def \phoneicon {\faPhone}
\def \phonetext {+34 666 14 28 91}

\def \emailicon {\faEnvelope}
\def \emaillink {mailto:santi.cr.iinf@gmail.com}
\def \emailtext {santi.cr.iinf@gmail.com}

\def \githubicon {\faGithub}
\def \githublink {https://github.com/Stoneerr}
\def \githubtext {/stoneerr}
...
\newcommand{\doublecol}[6]{
  \begin{tabularx}{\textwidth}{Xr}
    {
      \begin{tabular}[c]{l}
        {\vspace{5pt}} \fontsize{35}{45}\selectfont{\color{primary}{{\textbf{\fullname}}}} \\
...
\headertype{\phone}{\email}{\linkedin}{}{}{} % Set the order of items here
